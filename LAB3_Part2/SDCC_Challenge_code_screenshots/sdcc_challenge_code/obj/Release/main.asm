...
;------------------------------------------------------------
;	main.c:25: void dataout(uint8_t x)
;	-----------------------------------------
;	 function dataout
;	-----------------------------------------
_dataout:
...
;	-----------------------------------------
_main:
;	main.c:47: uint16_t totalstoragecount = 0;
	mov	dptr,#_main_totalstoragecount_131072_67
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	main.c:52: uint16_t totalcharafterQ =0;
...
;	main.c:61: while(1)
	...
	mov	r7,#0x00
00112$:
;	main.c:64: printf("### Enter a valid buffer size for buffer 0 and 1 ###");
	push	ar7
	push	ar6
	mov	a,#___str_0
	push	acc
	...
	dec	sp
	dec	sp
;	main.c:65: uint16_t m= takeinput();
	lcall	_takeinput
	mov	r4,dpl
	mov	r5,dph
	pop	ar6
	pop	ar7
;	main.c:66: if (m>=32 && m<=3200)
	mov	ar2,r4
	mov	ar3,r5
	clr	c
	mov	a,r2
	...
	subb	a,r3
	jc	00102$
;	main.c:69: buffer[0] = (uint8_t *)malloc(m);
	mov	dpl,r4
	mov	dph,r5
	push	ar7
	push	ar6
...
;	main.c:82: printf_tiny("\n \rMalloc buffer0 passed\n\r");
	...
	pop	ar6
	pop	ar7
;	main.c:84: startaddr[0]= (int)buffer[0];
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
	mov	r2,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	main.c:85: endaddr[0]= (int)(buffer[0]+ m);
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
	mov	r1,a
	inc	dptr
...
;	main.c:87: printf("\n \rBuffer 0 created at :0X0%x \n \r",startaddr[buffnewcount]);
	...
	pop	ar6
	pop	ar7
;	main.c:88: buffnewcount++;
	inc	r6
	cjne	r6,#0x00,00300$
	inc	r7
00300$:
00106$:
;	main.c:91: if (m<1980 && buffer[0] !=0)
	mov	ar2,r4
	mov	ar3,r5
	clr	c
	mov	a,r2
...
00301$:
	...
	ljmp	00108$
00302$:
;	main.c:93: buffer[1] = (uint8_t *)malloc(m);
	mov	dpl,r4
	mov	dph,r5
	push	ar7
	push	ar6
	...
	inc	dptr
	movx	@dptr,a
;	main.c:94: startaddr[1]= (int)buffer[1];
	...
	inc	dptr
	movx	@dptr,a
;	main.c:95: endaddr[1]= (int)(buffer[1]+ m);
	mov	a,r4
...
;	main.c:100: buffnewcount++;
	...
	inc	dptr
	movx	@dptr,a
;	main.c:101: storagecountall[0]=0;
	mov	dptr,#_main_storagecountall_131072_67
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	main.c:102: freespacesbuff[0]=buff01size;
	mov	dptr,#_buff01size
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	main.c:103: freespacesbuff[1]= buff01size;
	mov	dptr,#_buff01size
	movx	a,@dptr
	mov	r4,a
	inc	dptr
...
;	main.c:123: printf_tiny("\n \rEnter character \n \r");
	...
	dec	sp
	dec	sp
;	main.c:124: uint16_t takechar = getchar();
	lcall	_getchar
	mov	_main_sloc5_1_0,dpl
	mov	(_main_sloc5_1_0 + 1),dph
	pop	ar4
	pop	ar5
;	main.c:125: totalcharcount++;
	inc	r4
	cjne	r4,#0x00,00303$
	inc	r5
00303$:
;	main.c:126: if(takechar !='?')
	mov	a,#0x3f
	cjne	a,_main_sloc5_1_0,00304$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00304$
	sjmp	00115$
00304$:
;	main.c:128: totalcharafterQ++;
	mov	dptr,#_main_totalcharafterQ_131072_67
	movx	a,@dptr
	add	a,#0x01
	movx	@dptr,a
...
;	main.c:130: printf("\n \rTotal number of characters =%d \n \r",totalcharcount);
	...
	add	a,#0xfb
	mov	sp,a
;	main.c:131: putchar(takechar);
	mov	dpl,_main_sloc5_1_0
	mov	dph,(_main_sloc5_1_0 + 1)
	lcall	_putchar
	pop	ar4
	pop	ar5
;	main.c:132: if ((takechar>96 && takechar<123) && freespacesbuff[0] !=0)      // to get character from 'a' to 'z' and store in Buffer 0
...
;	main.c:134: DEBUGPORT(0xAA);
	...
	pop	ar4
	pop	ar5
;	main.c:135: *(buffer[0]+ totalstoragecount) = takechar;
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
	...
	mov	a,r4
	lcall	__gptrput
;	main.c:137: printf(" --> This character is stored at %p \n",(buffer[0]+totalstoragecount));
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
	mov	r1,a
	inc	dptr
...
;	main.c:140: totalstoragecount++;
	...
	inc	dptr
	movx	@dptr,a
;	main.c:142: storagecountall[0]=totalstoragecount;
	mov	dptr,#_main_totalstoragecount_131072_67
	movx	a,@dptr
	mov	r4,a
	inc	dptr
	...
	inc	dptr
	movx	@dptr,a
;	main.c:143: freespacesbuff[0]= buff01size - storagecountall[0];
	mov	dptr,#_buff01size
	movx	a,@dptr
	mov	r0,a
	inc	dptr
...
;	main.c:144: printf("\n \r Total number of storage characters =%d \n",totalstoragecount);
00117$:
;	main.c:146: if (takechar=='+')      //to create a new buffer
	mov	a,#0x2b
	cjne	a,_main_sloc5_1_0,00308$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00308$
	sjmp	00309$
00308$:
	ljmp	00124$
00309$:
;	main.c:148: DEBUGPORT(0xBB);
	push	ar4
	push	ar5
	mov	dpl,#0xbb
	push	ar5
...
;	main.c:149: printf("\n \r You need to enter a number between 30 to 300 bytes to create a new buffer \n");
	...
	dec	sp
	dec	sp
;	main.c:150: uint16_t n= takeinput();
	lcall	_takeinput
	mov	_main_sloc0_1_0,dpl
	mov	(_main_sloc0_1_0 + 1),dph
	pop	ar4
	pop	ar5
;	main.c:151: if (n>=30 && n<=300){
...
00310$:
	...
	ljmp	00124$
00311$:
;	main.c:152: buffer[buffnewcount] = (uint8_t *)malloc(n);
	push	ar4
	push	ar5
	...
	inc	dptr
	movx	@dptr,a
;	main.c:153: startaddr[buffnewcount] = (int)buffer[buffnewcount];
	mov	a,_main_sloc4_1_0
	...
	inc	dptr
	movx	@dptr,a
;	main.c:154: endaddr[buffnewcount]= (int)(buffer[buffnewcount]+ n);
	mov	a,_main_sloc3_1_0
	...
	inc	dptr
	movx	@dptr,a
;	main.c:155: buffersizes[buffnewcount]= n;
	mov	a,_main_sloc3_1_0
	...
	inc	dptr
	movx	@dptr,a
;	main.c:156: storagecountall[buffnewcount]=0;
	mov	a,_main_sloc3_1_0
	...
	inc	dptr
	movx	@dptr,a
;	main.c:157: freespacesbuff[buffnewcount]= n - storagecountall[buffnewcount];
	mov	a,_main_sloc3_1_0
...
;	main.c:159: printf("\n \r Address of buffer no %d: %p \n \r",buffnewcount, buffer[buffnewcount]);
	...
	pop	ar4
	pop	ar5
;	main.c:160: buffnewcount++;
	inc	_main_sloc4_1_0
	clr	a
	cjne	a,_main_sloc4_1_0,00312$
...
;	main.c:160: buffnewcount++;
00124$:
;	main.c:163: if (takechar=='-')   // TO delete a buffer
	mov	a,#0x2d
	cjne	a,_main_sloc5_1_0,00313$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00313$
	sjmp	00314$
00313$:
	ljmp	00130$
00314$:
;	main.c:165: DEBUGPORT(0xCC);
	push	ar4
	push	ar5
	mov	dpl,#0xcc
	push	ar5
...
;	main.c:166: printf("\n \r You need to enter a valid buffer number to clear it \n");
	...
	dec	sp
	dec	sp
;	main.c:167: uint16_t buffno = takeinput();
	lcall	_takeinput
	mov	_main_sloc3_1_0,dpl
	mov	(_main_sloc3_1_0 + 1),dph
	pop	ar4
	pop	ar5
;	main.c:168: if ((buffno <= buffnewcount) && (buffno != 0))
...
;	main.c:177: printf("\n \r You entered a wrong Buffer number \n \r");
	...
	pop	ar5
00130$:
;	main.c:180: if (takechar=='?')    // To give a detailed Heap report,Print Buffer 0 contents and clear Buffer 0
	mov	a,#0x3f
	cjne	a,_main_sloc5_1_0,00317$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00317$
	sjmp	00318$
00317$:
	ljmp	00138$
00318$:
;	main.c:182: DEBUGPORT(0xDD);
	mov	dpl,#0xdd
	push	ar5
	push	ar4
	lcall	_dataout
...
;	main.c:186: printf("\n\rBuffer\tStarting Addr\tEsnding Addr\tSize\tStorageChar\t Free Space \n");
	...
	pop	ar4
	pop	ar5
;	main.c:187: for (d=0; d< buffnewcount; d++)
...
;	main.c:197: printf("\n \rData at Buffer 0: \t");
	...
	pop	ar4
	pop	ar5
;	main.c:198: for(e=0; e< totalstoragecount; e++)
	mov	dptr,#_main_totalstoragecount_131072_67
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
00157$:
	...
	ljmp	00136$
00322$:
;	main.c:200: printf("%c  ",*(buffer[0]+e));
	push	ar4
	push	ar5
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
...
00325$:
	ljmp	00157$
00136$:
;	main.c:206: totalstoragecount=0;
	mov	dptr,#_main_totalstoragecount_131072_67
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
00138$:
;	main.c:209: if (takechar=='=')    //  Data printing of buffer 0
	mov	a,#0x3d
	cjne	a,_main_sloc5_1_0,00326$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00326$
	sjmp	00327$
00326$:
	ljmp	00143$
00327$:
;	main.c:211: DEBUGPORT(0xE5);
	mov	dpl,#0xe5
	push	ar5
	push	ar4
	lcall	_dataout
;	main.c:212: printf("\n \r ########## Data Inside Buffer 0 ##############");
	...
	pop	ar4
	pop	ar5
;	main.c:214: for(g=0; g< totalstoragecount; g++)
	mov	dptr,#_main_totalstoragecount_131072_67
	movx	a,@dptr
	mov	r6,a
	inc	dptr
...
;	main.c:218: printf("\n \r %p :",(buffer[0]+g));
00140$:
;	main.c:220: printf("%x ",*(buffer[0]+g));
	push	ar4
	push	ar5
	mov	dptr,#_main_buffer_131072_67
	movx	a,@dptr
...
00330$:
	...
	ljmp	00160$
00143$:
;	main.c:223: if (takechar=='@')     //to clear all the buffers
	mov	a,#0x40
	cjne	a,_main_sloc5_1_0,00331$
	clr	a
	cjne	a,(_main_sloc5_1_0 + 1),00331$
	sjmp	00332$
00331$:
	ljmp	00148$
00332$:
;	main.c:225: DEBUGPORT(0xAC);
	mov	dpl,#0xac
	push	ar5
	push	ar4
	lcall	_dataout
;	main.c:229: printf("\n \r ########## All Buffers Cleared ##############");
	...
	pop	ar4
	pop	ar5
;	main.c:230: for (k=0; k<buffnewcount; k++)
...
;------------------------------------------------------------
;	main.c:247: int takeinput()  // to take input from a user
;	-----------------------------------------
;	 function takeinput
;	-----------------------------------------
_takeinput:
...
;	main.c:257: if (no>47 && no<58){
	...
	subb	a,#0x00
	jnc	00107$
;	main.c:258: number = (number*10) + (no - '0');
	mov	dptr,#_takeinput_number_65537_103
	movx	a,@dptr
	mov	r2,a
	inc	dptr
